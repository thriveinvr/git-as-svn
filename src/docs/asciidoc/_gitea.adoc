...
* Support for Gitea user or organization owned repositories
* Usage of repository deploy keys to override commit permissions
* Path-based authorization including support for Gitea repository teams
* Usage of Gitea LFS server for transparent handling of LFS files for svn users
* Automatic discovery of new repositories and branches created in Gitea
